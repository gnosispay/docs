...
Changing this randomly assigned PIN requires the user to visit an ATM.

For detailed instructions, please refer to the [PSE SDK documentation](https://www.npmjs.com/package/@gnosispay/pse-sdk).
...
This endpoint allows you to issue virtual card without requiring a card order. Virtual cards are free and activated immediately. No shipping address or payment validation is required.
