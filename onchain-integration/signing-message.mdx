---
title: Sign Messages with Gnosis Pay Safe
description: Learn how to sign messages using your Gnosis Pay Safe account with the delay module for enhanced security.
---

Unlike traditional EOA (Externally Owned Account) message signing, Gnosis Pay Safe message signing goes through the delay module.

<Note>
Message signing with Gnosis Pay Safe requires the account to be fully configured with the delay module enabled. If you haven't set up your Safe account yet, see the [Safe Account Configuration](/onboarding-flow#4-safe-account-configuration) section first.
</Note>

## Message Signing Process

Gnosis Pay Safe message signing follows the same two-phase pattern as other delayed operations:
