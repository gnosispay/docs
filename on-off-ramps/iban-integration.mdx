...
To retrieve IBAN details including the IBAN number, BIC code, status, and connected blockchain address, use Monerium's dedicated [IBAN endpoint](https://monerium.dev/api-docs/v2#tag/ibans/operation/ibans) to fetch all relevant account information.
...
The Gnosis Pay API serves as a wrapper for Monerium IBAN integration. Therefore, any issues related to Monerium integration should be addressed directly between partner products and Monerium.
</Warning>
