...
<Table>
  <TableHead>
    <TableRow>
      ...
      <TableHeader>What your user should do</TableHeader>
    </TableRow>
  </TableHead>
  <TableBody>
    <TableRow>
      <TableCell><Code>notStarted</Code></TableCell>
      <TableCell>No KYC process started</TableCell>
      <TableCell>Start KYC</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><Code>documentsRequested</Code></TableCell>
      <TableCell>Applicant must upload documents. Status moves to <Code>pending</Code> when done.</TableCell>
      <TableCell>Upload documents</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><Code>pending</Code></TableCell>
      <TableCell>Awaiting verification processing</TableCell>
      <TableCell>Nothing—just wait!</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><Code>processing</Code></TableCell>
      <TableCell>Profile is being processed</TableCell>
      <TableCell>Nothing—system is checking</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><Code>approved</Code></TableCell>
      <TableCell>All verification checks passed</TableCell>
      <TableCell>Nothing—KYC is complete</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><Code>resubmissionRequested</Code></TableCell>
      <TableCell>Some checks failed; user can re-submit required steps</TableCell>
      <TableCell>Re-submit documents</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><Code>rejected</Code></TableCell>
      <TableCell>Final rejection; user cannot try again</TableCell>
      <TableCell>Nothing (final rejection)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell><Code>requiresAction</Code></TableCell>
      <TableCell>Manual check required by our team</TableCell>
      <TableCell>Wait or contact support</TableCell>
    </TableRow>
  </TableBody>
</Table>
  ...
  "questions": [
    {
      ...
      "options": ["Employment", "Business", "Investment", "Other"]
    }
  ]
}
```
...
<Warning>
This endpoint waits for on-chain confirmation (it can take up to 10 seconds). The response will include `deployed: true` if it worked, and a `transactionHash` you can use to track it.
</Warning>
