...
<Step title="Complete SOF">
    ...
    source-of-funds`](/api-reference/user/get-sof-questions) endpoint.
...
<Steps>
    ...
    <Step title="Create GP Account">
        In this step, you will initiate the Gnosis Pay account provisioning and creation process. Call [`POST /user/account`](/api-reference/user/account) endpoint to create an account for the authenticated user.
