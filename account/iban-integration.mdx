...
1. If the User is not registered with Monerium you will receive a `"success": true` and it will take 3+ minutes (due to the delay module that verifies the signature and ownership of the address) for the new Monerium account to be created;
