...
- No requirement on partners side for dual KYC, they can rely on this endpoint for KYC requirements of monerium.

- Partner can link new addresses and enable these accounts to work with whitelisted applications through [Monerium API](https://monerium.dev/api-docs/v2)
...
<Warning>
Monerium only allows the user to have one single account with them. If monerium account **already exists**, then there is **no need** to call this endpoint.
</Warning>
