...
For more information about Safe account setup and module deployment, see the [Safe Management API documentation](https://docs.gnosispay.com/api-reference/safe-management/deploy-safe-modules-with-a-user-signature).
</Warning>
...
You can monitor the transaction status using the [delay-relay monitoring endpoint](https://docs.gnosispay.com/api-reference/account-management/retrieve-the-list-of-delayed-transactions-for-the-authenticated-user) or by checking your Safe's transaction history.
