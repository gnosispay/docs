...
<CardGroup cols={2}>
  <Card
    ...
    icon="bolt"
    href="/cards/create-virtual-cards"
  >
  ...
  <Card
    title="💱 Best FX Rates"
    icon="chart-line"
    href="/transactions/integration-guide"
  >
    Leverage the power of DeFi to get the best foreign exchange rates.
  </Card>
