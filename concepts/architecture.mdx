...
You integrate with Gnosis Pay infrastructure and get assigned a TenantID (also referred as PartnerID, which is an identifier for you as a partner) and allows us to spin up dedicated credentials to access user base.
