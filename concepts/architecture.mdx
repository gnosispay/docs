...
You integrate with Gnosis Pay infrastructure and get assigned a TenantID (also referred as PartnerID). This is a unique identifier for you as a partner and allows us to spin up dedicated credentials to access user base.
...
<CardGroup cols={2}>
  ...
  <Card title="Webhooks" icon="bell">
    Subscribe to real-time events to keep your systems in sync and power your user notifications.
  </Card>
  <Card title="Partner Dashboard" icon="gauge">
    Manage your program, support your users (B2C), and access analytics and user data. You own the relationship directly.
  </Card>
