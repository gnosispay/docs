...
This page lists every code by category, the message shown to the user, and the technical reason behind it. This is useful when investigating a specific decline with your support team.
