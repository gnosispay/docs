...
<CardGroup cols={2}>
  <Card title="Instant withdrawals" icon="bolt">
    Fully self-custodial. Withdraw your balance instantly with no lock-up periods and no settlement delays.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Custom limits" icon="sliders">
    Set account-level and card-level spending limits per user.
  </Card>
