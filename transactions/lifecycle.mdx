...
Reversals can also occur at clearing level:

<Steps>
  <Step title="Clearing Reversal">
    Merchant submits clearing reversal (BaseII codes "26" or "27")
  </Step>
  <Step title="Transaction Correction">
    Original clearing is reversed or corrected
  </Step>
  <Step title="API Update">
    Appears as reversal transaction or updates original payment
  </Step>
</Steps>
